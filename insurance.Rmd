...
ggarrange(plotlist=box_plots, height = .5, ncol = 3) # layout plots
...
p1<-ks_plot(trans_actuals, trans_predicts) #cum perc of ones captured by the model against that expected random
